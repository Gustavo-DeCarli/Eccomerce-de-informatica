    ...
    <header class="p-3 bg-dark text-white">
        <div class="container-fluid">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <form method='POST' action='index.php' class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-5">
            ...
            if (!isset($_POST['busca'])) {
                $dados = $connection->query("SELECT * from produtos ORDER BY RAND() LIMIT $inicio,$total_reg");
            } else {
                $nome = $_POST['busca'];
                $dados = $connection->query("SELECT * from produtos WHERE nome LIKE '%$nome%' ORDER BY RAND() LIMIT $inicio,$total_reg");
            }
